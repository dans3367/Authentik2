/**
 * Newsletter Reaction HTML Builder for Trigger.dev
 * 
 * Standalone version of the reaction buttons builder for use in Trigger.dev tasks.
 * Generates per-recipient reaction buttons HTML for newsletter emails.
 */
