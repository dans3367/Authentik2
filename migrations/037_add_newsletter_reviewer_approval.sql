...
ALTER TABLE "newsletters" ADD COLUMN IF NOT EXISTS "reviewer_id" varchar REFERENCES "better_auth_user"("id");
...
CREATE TABLE IF NOT EXISTS "newsletter_reviewer_settings" (
  ...
  "reviewer_id" varchar REFERENCES "better_auth_user"("id") ON DELETE SET NULL,
