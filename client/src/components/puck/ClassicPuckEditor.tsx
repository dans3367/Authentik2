    ...
    headerActions: () => (
      <>
        ...
        <div style={{ display: "flex", gap: "4px", marginRight: "8px" }}>
          <button onClick={() => onSetViewport("mobile")} style={{ padding: "8px", background: viewport === "mobile" ? "#2563eb" : isDark ? "hsl(215, 20%, 16%)" : "#fff", color: viewport === "mobile" ? "#fff" : isDark ? "#d1d5db" : "#000", border: isDark ? "1px solid hsl(215, 20%, 25%)" : "1px solid #e5e7eb", borderRadius: "4px", cursor: "pointer", display: "flex", alignItems: "center", gap: "4px" }} title={String(t("newsletter.create.mobileView", { defaultValue: "Mobile view" }))} data-testid="viewport-mobile"><Smartphone size={16} /><span style={{ fontSize: "12px" }}>360px</span></button>
          <button onClick={() => onSetViewport("desktop")} style={{ padding: "8px", background: viewport === "desktop" ? "#2563eb" : isDark ? "hsl(215, 20%, 16%)" : "#fff", color: viewport === "desktop" ? "#fff" : isDark ? "#d1d5db" : "#000", border: isDark ? "1px solid hsl(215, 20%, 25%)" : "1px solid #e5e7eb", borderRadius: "4px", cursor: "pointer", display: "flex", alignItems: "center", gap: "4px" }} title={String(t("newsletter.create.desktopView", { defaultValue: "Desktop view" }))} data-testid="viewport-desktop"><Monitor size={16} /><span style={{ fontSize: "12px" }}>{String(t("newsletter.create.full", { defaultValue: "Full" }))}</span></button>
        </div>
        <div style={{ display: "flex", gap: "4px", marginRight: "8px", alignItems: "center" }}>
          <button onClick={onZoomOut} disabled={zoom <= 25} style={{ padding: "8px", background: isDark ? "hsl(215, 20%, 16%)" : "#fff", color: zoom <= 25 ? "#9ca3af" : isDark ? "#d1d5db" : "#000", border: isDark ? "1px solid hsl(215, 20%, 25%)" : "1px solid #e5e7eb", borderRadius: "4px", cursor: zoom <= 25 ? "not-allowed" : "pointer", display: "flex", alignItems: "center", gap: "4px" }} title={String(t("newsletter.create.zoomOut", { defaultValue: "Zoom out" }))} data-testid="zoom-out"><ZoomOut size={16} /></button>
          <button onClick={onZoomReset} style={{ padding: "8px 12px", background: isDark ? "hsl(215, 20%, 16%)" : "#fff", color: isDark ? "#d1d5db" : "#000", border: isDark ? "1px solid hsl(215, 20%, 25%)" : "1px solid #e5e7eb", borderRadius: "4px", cursor: "pointer", fontSize: "12px", fontWeight: 500, minWidth: "60px" }} title={String(t("newsletter.create.resetZoom", { defaultValue: "Reset zoom" }))} data-testid="zoom-reset">{zoom}%</button>
          <button onClick={onZoomIn} disabled={zoom >= 100} style={{ padding: "8px", background: isDark ? "hsl(215, 20%, 16%)" : "#fff", color: zoom >= 100 ? "#9ca3af" : isDark ? "#d1d5db" : "#000", border: isDark ? "1px solid hsl(215, 20%, 25%)" : "1px solid #e5e7eb", borderRadius: "4px", cursor: zoom >= 100 ? "not-allowed" : "pointer", display: "flex", alignItems: "center", gap: "4px" }} title={String(t("newsletter.create.zoomIn", { defaultValue: "Zoom in" }))} data-testid="zoom-in"><ZoomIn size={16} /></button>
        </div>
