...
export default function ECardsPage() {
  ...
  const christmasThemes = useMemo(() => ([
    ...
    {
      id: 'confetti',
      legacyId: 'snowy-night',
      name: t('ecards.themes.christmas.snowyNight'),
      image: 'https://images.unsplash.com/photo-1512317052271-03dcd8aefb21?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      overlay: 'bg-black/50',
      decorations: (
        <>
          <Snowflake className="absolute left-3 top-3 h-6 w-6 text-white opacity-80" />
          <Snowflake className="absolute right-5 top-8 h-5 w-5 text-white opacity-70" />
        </>
      )
    },
    {
      id: 'balloons',
      legacyId: 'cozy-fireplace',
      name: t('ecards.themes.christmas.cozyFireplace'),
      image: 'https://images.unsplash.com/photo-1454372182658-c712e4c5a1db?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      overlay: 'bg-black/30',
      decorations: (
        <>
  ...
  const stPatrickThemes = useMemo(() => ([
    {
      ...
      image: 'https://images.unsplash.com/photo-1520880867055-1e30d1cb001c?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0',
      overlay: 'bg-black/20',
      decorations: (
        <>
    ...
    {
      id: 'emerald-fields',
      name: t('ecards.themes.stPatricksDay.emeraldFields'),
      image: 'https://images.unsplash.com/photo-1463680942456-e4230dbeaec7?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0',
      overlay: 'bg-black/20',
      decorations: (
        <>
          <span className="absolute left-3 top-3 text-2xl opacity-90">🌿</span>
    ...
    {
      id: 'lucky-clovers',
      name: t('ecards.themes.stPatricksDay.luckyClovers'),
      image: 'https://images.unsplash.com/photo-1464983953574-0892a716854b?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0',
      overlay: 'bg-black/20',
      decorations: (
        <>
          <span className="absolute left-4 top-4 text-2xl opacity-90">🍀</span>
          <span className="absolute right-5 top-8 text-xl opacity-80">🍻</span>
        </>
      )
    },
  ]), [t]);
  ...
  const mothersThemes = useMemo(() => ([
    ...
    {
      id: 'breakfast-in-bed',
      name: t('ecards.themes.mothersDay.breakfastInBed'),
      image: 'https://images.unsplash.com/photo-1504754524776-8f4f37790ca0?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0',
      overlay: 'bg-black/20',
      decorations: (
        <>
          <span className="absolute left-3 top-3 text-2xl opacity-90">☕</span>
    ...
    {
      id: 'heartfelt-moments',
      name: t('ecards.themes.mothersDay.heartfeltMoments'),
      image: 'https://images.unsplash.com/photo-1496307138366-3e4e71712b38?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0',
      overlay: 'bg-black/20',
      decorations: (
        <>
          <span className="absolute left-4 top-4 text-2xl opacity-90">💐</span>
  ...
  const fathersThemes = useMemo(() => ([
    ...
    {
      id: 'grill-master',
      name: t('ecards.themes.fathersDay.grillMaster'),
      image: 'https://images.unsplash.com/photo-1514512364185-4c2b1b17434b?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0',
      overlay: 'bg-black/30',
      decorations: (
        <>
          <span className="absolute left-3 top-3 text-2xl opacity-90">🔥</span>
    ...
    {
      id: 'sports-day',
      name: t('ecards.themes.fathersDay.sportsDay'),
      image: 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0',
      overlay: 'bg-black/20',
      decorations: (
        <>
          <span className="absolute left-4 top-4 text-2xl opacity-90">🏈</span>
  ...
  const independenceThemes = useMemo(() => ([
    {
      ...
      image: 'https://images.unsplash.com/photo-1531928351158-2f736078e0a1?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      overlay: 'bg-black/30',
      decorations: (
        <>
          <span className="absolute left-3 top-3 text-2xl opacity-90">⭐</span>
    ...
    {
      id: 'fireworks-night',
      name: t('ecards.themes.independenceDay.fireworksNight'),
      image: 'https://images.unsplash.com/photo-1467810563316-b5476525c0f9?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      overlay: 'bg-black/40',
      decorations: (
        <>
          <span className="absolute left-3 top-3 text-2xl opacity-90">🎆</span>
    ...
    {
      id: 'patriotic-parade',
      name: t('ecards.themes.independenceDay.patrioticParade'),
      image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      overlay: 'bg-black/35',
      decorations: (
        <>
          <span className="absolute left-4 top-4 text-2xl opacity-90">🎺</span>
  ...
  const easterThemes = useMemo(() => ([
    {
      ...
      image: 'https://images.unsplash.com/photo-1528825871115-3581a5387919?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0',
      overlay: 'bg-black/20',
      decorations: (
        <>
          <span className="absolute left-3 top-3 text-2xl opacity-90">🥚</span>
    ...
    {
      id: 'spring-bloom',
      name: t('ecards.themes.easter.springBloom'),
      image: 'https://images.unsplash.com/photo-1464965911861-746a04b4bca6?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0',
      overlay: 'bg-black/20',
      decorations: (
        <>
          <span className="absolute left-3 top-3 text-2xl opacity-90">🌸</span>
    ...
    {
      id: 'bunny-joy',
      name: t('ecards.themes.easter.bunnyJoy'),
      image: 'https://images.unsplash.com/photo-1452570053594-1b985d6ea890?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0',
      overlay: 'bg-black/20',
      decorations: (
        <>
          <span className="absolute left-4 top-4 text-2xl opacity-90">🐰</span>
  ...
  const newYearThemes = useMemo(() => ([
    {
      ...
      image: 'https://images.unsplash.com/photo-1514923995763-768e52f5af87?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0',
      overlay: 'bg-black/40',
      decorations: (
        <>
          <span className="absolute left-3 top-3 text-2xl opacity-90">🎆</span>
    ...
    {
      id: 'city-fireworks',
      name: t('ecards.themes.newYear.cityFireworks'),
      image: 'https://images.unsplash.com/photo-1543810577-47f910539517?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0',
      overlay: 'bg-black/40',
      decorations: (
        <>
          <span className="absolute left-3 top-3 text-2xl opacity-90">🏙️</span>
    ...
    {
      id: 'golden-countdown',
      name: t('ecards.themes.newYear.goldenCountdown'),
      image: 'https://images.unsplash.com/photo-1457377807177-7cbb3a5d64e3?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0',
      overlay: 'bg-black/30',
      decorations: (
        <>
          <span className="absolute left-4 top-4 text-2xl opacity-90">⏳</span>
  ...
  const valentineThemes = useMemo(() => ([
    {
      ...
      image: 'https://images.unsplash.com/photo-1457089328109-e5d9bd499191?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      overlay: 'bg-black/30',
      decorations: (
        <>
          <span className="absolute left-3 top-3 text-2xl opacity-90">🌹</span>
    ...
    {
      id: 'sweet-hearts',
      name: t('ecards.themes.valentine.sweetHearts'),
      image: 'https://images.unsplash.com/photo-1455659817273-f96807779a8e?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      overlay: 'bg-black/20',
      decorations: (
        <>
          <span className="absolute left-3 top-3 text-2xl opacity-90">💖</span>
    ...
    {
      id: 'starlit-sky',
      name: t('ecards.themes.valentine.starlitSky'),
      image: 'https://images.unsplash.com/photo-1421986527537-888d998adb74?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      overlay: 'bg-black/40',
      decorations: (
        <>
          <span className="absolute left-4 top-4 text-2xl opacity-90">✨</span>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-2">
                    ...
                    return (
                      ...
                      >
                        <div className="relative h-40 rounded-lg overflow-hidden">
                          <img src={tpl.image} alt={tpl.name} className="absolute inset-0 h-full w-full object-cover" />
                          <div className={`absolute inset-0 ${tpl.overlay}`} />
                          {tpl.decorations}
                            ...
                            <div className="text-center">
                              <div className="font-bold text-white drop-shadow-lg text-shadow">
                                {(() => {
                                  ...
                                  let savedTitle = null as string | null;
                                  if (birthdaySettings?.customThemeData) {
                                    try {
                                      const parsed = JSON.parse(birthdaySettings.customThemeData);
                                  ...
                                  if (previewData?.title !== undefined) return previewData.title || defaultPreviewTitle;
                                  if (savedTitle !== null) return savedTitle || defaultPreviewTitle;
                                  return defaultPreviewTitle;
                                })()}
                              </div>
                  ...
                  <button
                    ...
                    disabled={updateSettingsMutation.isPending}
                    className={`relative rounded-xl border p-3 text-left transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 ${birthdaySettings?.emailTemplate === 'custom' ? 'ring-2 ring-blue-600 border-blue-600' : 'border-gray-200 hover:border-gray-300'}`}
                  >
                    <div className="relative h-40 rounded-lg overflow-hidden">
                      {(() => {
                        ...
                        if (customData?.imageUrl) {
                          return (
                            <>
                              <img src={customData.imageUrl} alt="Custom theme" className="absolute inset-0 h-full w-full object-cover" />
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center">
                          <div className="font-bold text-white drop-shadow-lg text-shadow">
                            {(() => {
                              const previewData = themePreviewData['custom'];
                              let savedTitle = null as string | null;
                              if (birthdaySettings?.customThemeData) {
                                try {
                                  const parsed = JSON.parse(birthdaySettings.customThemeData);
                                  const themeSpecificData = parsed.themes?.['custom'];
                                  if (themeSpecificData?.title !== undefined) savedTitle = themeSpecificData.title;
                                } catch {}
                              }
                              const customData = previewData || customThemePreview;
                              return customData?.title || savedTitle || defaultPreviewTitle;
                            })()}
                          </div>
                          <div className="text-xs text-white/90 drop-shadow">Custom preview</div>
                        </div>
                      </div>
                    </div>
                    <div className="mt-2 flex items-center justify-between">
                      <span className="text-sm font-medium text-gray-900">Custom</span>
                      {birthdaySettings?.emailTemplate === 'custom' && (
                        <span className="text-xs font-semibold text-blue-600">Selected</span>
                      )}
                    </div>
                  </button>
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-2">
                    ...
                    <button
                      type="button"
                      onClick={() => handleToggleHoliday('valentine')}
                      disabled={updateSettingsMutation.isPending}
                      className={`relative rounded-xl border p-3 text-left transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 ${
                        disabledHolidays.includes('valentine')
                          ? 'ring-2 ring-blue-600 border-blue-600 bg-blue-50'
                          : 'border-gray-200 hover:border-gray-300'
                      }`}
                    >
                      <div className="relative h-40 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center">
                        <div className="text-center">
                          <XCircle className="h-12 w-12 text-gray-400 mx-auto mb-2" />
                          <div className="font-bold text-gray-600">None</div>
                          <div className="text-xs text-gray-500 mt-1">No Valentine's card</div>
                        </div>
                      </div>
                      <div className="mt-2 flex items-center justify-between">
                    ...
                    {valentineThemes.map((theme) => {
                      const isSelected = (birthdaySettings?.emailTemplate === 'custom') && (() => {
                        try {
                          if (themePreviewData['custom']?.imageUrl) return themePreviewData['custom']?.imageUrl === theme.image;
                          if (birthdaySettings?.customThemeData) {
                            const parsed = JSON.parse(birthdaySettings.customThemeData);
                            const customData = parsed.themes?.custom;
                                ...
                                <div className="font-bold text-white drop-shadow-lg text-shadow">
                                  ...
                                  {(() => {
                                    try {
                                      ...
                                      const title = (themePreviewData['custom']?.title) || (saved?.themes?.custom?.title) || 'Happy Valentine\'s Day!';
                                      return title;
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-2">
                    ...
                    <button
                      type="button"
                      onClick={() => handleToggleHoliday('stpatrick')}
                      disabled={updateSettingsMutation.isPending}
                      className={`relative rounded-xl border p-3 text-left transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 ${
                        disabledHolidays.includes('stpatrick')
                          ? 'ring-2 ring-blue-600 border-blue-600 bg-blue-50'
                          : 'border-gray-200 hover:border-gray-300'
                      }`}
                    >
                      <div className="relative h-40 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center">
                        <div className="text-center">
                          <XCircle className="h-12 w-12 text-gray-400 mx-auto mb-2" />
                          <div className="font-bold text-gray-600">None</div>
                          <div className="text-xs text-gray-500 mt-1">No St. Patrick's card</div>
                        </div>
                      </div>
                      <div className="mt-2 flex items-center justify-between">
                        <span className="text-sm font-medium text-gray-900">None</span>
                              ...
                              <div className="text-center">
                                <div className="font-bold text-white drop-shadow-lg text-shadow">
                                  {(() => {
                                    try {
                                      const saved = birthdaySettings?.customThemeData ? JSON.parse(birthdaySettings.customThemeData) : null;
                                      const title = (themePreviewData['custom']?.title) || (saved?.themes?.custom?.title) || "Happy St. Patrick's Day!";
                                      return title;
                ...
                {/* Mother's Day Row */}
                <div className="mt-6">
                  <Label className="text-sm">Mother's Day</Label>
                  <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-2">
                    {/* None Option */}
                    <button
                      type="button"
                      onClick={() => handleToggleHoliday('mothers')}
                      disabled={updateSettingsMutation.isPending}
                      className={`relative rounded-xl border p-3 text-left transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 ${
                        disabledHolidays.includes('mothers')
                          ? 'ring-2 ring-blue-600 border-blue-600 bg-blue-50'
                          : 'border-gray-200 hover:border-gray-300'
                      }`}
                    >
                      <div className="relative h-40 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center">
                        <div className="text-center">
                          <XCircle className="h-12 w-12 text-gray-400 mx-auto mb-2" />
                          <div className="font-bold text-gray-600">None</div>
                          <div className="text-xs text-gray-500 mt-1">No Mother's Day card</div>
                        </div>
                      </div>
                      <div className="mt-2 flex items-center justify-between">
                        <span className="text-sm font-medium text-gray-900">None</span>
                              ...
                              <div className="text-center">
                                <div className="font-bold text-white drop-shadow-lg text-shadow">
                                  {(() => {
                                    try {
                                      const saved = birthdaySettings?.customThemeData ? JSON.parse(birthdaySettings.customThemeData) : null;
                                      const title = (themePreviewData['custom']?.title) || (saved?.themes?.custom?.title) || "Happy Mother's Day!";
                                      return title;
                                    } catch { return "Happy Mother's Day!"; }
                                  })()}
                                </div>
                                <div className="text-xs text-white/90 drop-shadow">{theme.name} preview</div>
                              </div>
                ...
                {/* Father's Day Row */}
                <div className="mt-6">
                  <Label className="text-sm">Father's Day</Label>
                  <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-2">
                    {/* None Option */}
                    <button
                      type="button"
                      onClick={() => handleToggleHoliday('fathers')}
                      disabled={updateSettingsMutation.isPending}
                      className={`relative rounded-xl border p-3 text-left transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 ${
                        disabledHolidays.includes('fathers')
                          ? 'ring-2 ring-blue-600 border-blue-600 bg-blue-50'
                          : 'border-gray-200 hover:border-gray-300'
                      }`}
                    >
                      <div className="relative h-40 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center">
                        <div className="text-center">
                          <XCircle className="h-12 w-12 text-gray-400 mx-auto mb-2" />
                          <div className="font-bold text-gray-600">None</div>
                          <div className="text-xs text-gray-500 mt-1">No Father's Day card</div>
                        </div>
                      </div>
                      <div className="mt-2 flex items-center justify-between">
                        <span className="text-sm font-medium text-gray-900">None</span>
                              ...
                              <div className="text-center">
                                <div className="font-bold text-white drop-shadow-lg text-shadow">
                                  {(() => {
                                    try {
                                      const saved = birthdaySettings?.customThemeData ? JSON.parse(birthdaySettings.customThemeData) : null;
                                      const title = (themePreviewData['custom']?.title) || (saved?.themes?.custom?.title) || "Happy Father's Day!";
                                      return title;
                                    } catch { return "Happy Father's Day!"; }
                                  })()}
                                </div>
                                <div className="text-xs text-white/90 drop-shadow">{theme.name} preview</div>
                              </div>
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-2">
                    ...
                    <button
                      type="button"
                      onClick={() => handleToggleHoliday('newyear')}
                      disabled={updateSettingsMutation.isPending}
                      className={`relative rounded-xl border p-3 text-left transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 ${
                        disabledHolidays.includes('newyear')
                          ? 'ring-2 ring-blue-600 border-blue-600 bg-blue-50'
                          : 'border-gray-200 hover:border-gray-300'
                      }`}
                    >
                      <div className="relative h-40 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center">
                        <div className="text-center">
                          <XCircle className="h-12 w-12 text-gray-400 mx-auto mb-2" />
                          <div className="font-bold text-gray-600">None</div>
                          <div className="text-xs text-gray-500 mt-1">No New Year's card</div>
                        </div>
                      </div>
                      <div className="mt-2 flex items-center justify-between">
                        <span className="text-sm font-medium text-gray-900">None</span>
                              ...
                              <div className="text-center">
                                <div className="font-bold text-white drop-shadow-lg text-shadow">
                                  {(() => {
                                    try {
                                      const saved = birthdaySettings?.customThemeData ? JSON.parse(birthdaySettings.customThemeData) : null;
                                      const title = (themePreviewData['custom']?.title) || (saved?.themes?.custom?.title) || 'Happy New Year!';
                                      return title;
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-2">
                    ...
                    <button
                      type="button"
                      onClick={() => handleToggleHoliday('easter')}
                      disabled={updateSettingsMutation.isPending}
                      className={`relative rounded-xl border p-3 text-left transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 ${
                        disabledHolidays.includes('easter')
                          ? 'ring-2 ring-blue-600 border-blue-600 bg-blue-50'
                          : 'border-gray-200 hover:border-gray-300'
                      }`}
                    >
                      <div className="relative h-40 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center">
                        <div className="text-center">
                          <XCircle className="h-12 w-12 text-gray-400 mx-auto mb-2" />
                          <div className="font-bold text-gray-600">None</div>
                          <div className="text-xs text-gray-500 mt-1">No Easter card</div>
                        </div>
                      </div>
                      <div className="mt-2 flex items-center justify-between">
                        <span className="text-sm font-medium text-gray-900">None</span>
                              ...
                              <div className="text-center">
                                <div className="font-bold text-white drop-shadow-lg text-shadow">
                                  {(() => {
                                    try {
                                      const saved = birthdaySettings?.customThemeData ? JSON.parse(birthdaySettings.customThemeData) : null;
                                      const title = (themePreviewData['custom']?.title) || (saved?.themes?.custom?.title) || 'Happy Easter!';
                                      return title;
                                    } catch { return 'Happy Easter!'; }
                                  })()}
                                </div>
                                <div className="text-xs text-white/90 drop-shadow">{theme.name} preview</div>
                              </div>
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-2">
                    ...
                    <button
                      type="button"
                      onClick={() => handleToggleHoliday('independence')}
                      disabled={updateSettingsMutation.isPending}
                      className={`relative rounded-xl border p-3 text-left transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 ${
                        disabledHolidays.includes('independence')
                          ? 'ring-2 ring-blue-600 border-blue-600 bg-blue-50'
                          : 'border-gray-200 hover:border-gray-300'
                      }`}
                    >
                      <div className="relative h-40 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center">
                        <div className="text-center">
                          <XCircle className="h-12 w-12 text-gray-400 mx-auto mb-2" />
                          <div className="font-bold text-gray-600">None</div>
                          <div className="text-xs text-gray-500 mt-1">No Independence Day card</div>
                        </div>
                      </div>
                      <div className="mt-2 flex items-center justify-between">
                        <span className="text-sm font-medium text-gray-900">None</span>
                              ...
                              <div className="text-center">
                                <div className="font-bold text-white drop-shadow-lg text-shadow">
                                  {(() => {
                                    try {
                                      const saved = birthdaySettings?.customThemeData ? JSON.parse(birthdaySettings.customThemeData) : null;
                                      const title = (themePreviewData['custom']?.title) || (saved?.themes?.custom?.title) || 'Happy Independence Day!';
                                      return title;
