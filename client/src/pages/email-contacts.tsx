    ...
    <div className="min-h-screen bg-white dark:bg-slate-800">
      ...
      <CardContent className="p-0">
        ...
        <div className={`transition-all duration-300 ${isFetching ? 'opacity-70 scale-[0.995]' : 'opacity-100 scale-100'}`}>
          {/* Select All Header - responsive for all screens */}
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm">
                          <p className="font-medium" data-testid={`text-engagement-rate-${contact.id}`}>
                            {getEngagementRate(contact.emailsSent, contact.emailsOpened)}% open rate
                          </p>
                          <p className="text-gray-500" data-testid={`text-email-stats-${contact.id}`}>
                      ...
                      <div>
                        ...
                        <div className="text-sm">
                          <p data-testid={`text-added-date-${contact.id}`}>{formatDate(contact.addedDate)}</p>
                          {contact.lastActivity && (
                            <p className="text-gray-500" data-testid={`text-last-activity-${contact.id}`}>
