            ...
            <div className={`transition-all duration-300 mx-auto p-4 sm:p-6 bg-slate-200/50 dark:bg-slate-900/50 rounded-xl ${previewDevice === "mobile" ? "max-w-[400px]" : "w-full"
              ...
              <div className={`shadow-2xl mx-auto w-full relative ${
                previewDevice === "mobile"
                  ...
                  : "bg-white rounded-lg overflow-hidden max-w-[600px]"
                ...
                {previewDevice === "desktop" && (
                  <div className="bg-neutral-800 px-3 py-2 flex items-center gap-2 rounded-t-lg">
                    <div className="flex gap-1.5">
                      <div className="w-3 h-3 rounded-full bg-red-400" />
                      <div className="w-3 h-3 rounded-full bg-yellow-400" />
                      <div className="w-3 h-3 rounded-full bg-green-400" />
                    </div>
                    <div className="flex-1 bg-neutral-700 rounded px-2 py-0.5">&nbsp;</div>
                  </div>
                )}

                <div className={`text-slate-900 relative ${previewDevice === "mobile" ? "bg-white rounded-[2rem] overflow-hidden" : ""}`}>
