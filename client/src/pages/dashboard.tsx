...
export default function Dashboard() {
  ...
  return (
    <>
      <div className="container mx-auto p-4 lg:p-6 space-y-6 lg:space-y-8 overflow-y-auto">
            ...
            >
              ...
              <div className="flex items-end justify-between gap-2">
                ...
                {!highlightsLoading && stat.metric?.change !== null && stat.metric?.change !== undefined && (
                  <span
                    className={`inline-flex items-center gap-0.5 text-[11px] font-semibold px-1.5 py-0.5 rounded-md ${stat.metric.change >= 0
