...
const DEFAULT_ROLE_PERMISSIONS: Record<string, Record<string, boolean>> = {
  Owner: {
    ...
    'appointments.manage_availability': true,
    // Segments
    'segments.view': true,
  ...
  Manager: {
    ...
    'appointments.manage_notes': true,
    'appointments.send_reschedule': true,
    'appointments.manage_availability': false,
    'segments.view': true,
    'segments.create': true,
    'segments.edit': true,
...
const PERMISSION_CATEGORIES = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: 'appointments.manage_availability', label: 'Manage Availability', description: "Edit other providers' availability schedules" },
    ],
  },
  {
    key: 'segments',
