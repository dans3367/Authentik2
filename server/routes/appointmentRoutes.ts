...
import {
  acquireProviderScheduleLocks,
  collectProviderOverlapConflicts,
  isProviderConflictStatus,
  type AppointmentOverlapCandidate,
  type AppointmentOverlapConflict,
} from '../utils/appointmentOverlap';
...
// Provider overlap detection + advisory-lock helpers live in
// ../utils/appointmentOverlap (imported above) so the public booking route
// shares identical race semantics.
