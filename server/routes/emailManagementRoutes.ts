...
export function sanitizeEmailHtml(html: string): string {
  return xss(html, {
    ...
    // Disable CSS property filtering inside style attributes — the built-in
    // cssfilter strips email-critical properties like line-height and
    // mso-line-height-rule. Our HTML is generated by our own converter
    // pipeline so CSS-based XSS vectors are not a concern.
    css: false,
    stripIgnoreTag: true,
